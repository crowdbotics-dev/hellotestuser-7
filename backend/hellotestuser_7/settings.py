"""
Django settings for hellotestuser_7 project.
...
ROOT_URLCONF = 'hellotestuser_7.urls'
...
WSGI_APPLICATION = 'hellotestuser_7.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hellotestuser_7 API",
    "DESCRIPTION": "API documentation for hellotestuser_7 App",
    "VERSION": "v1",
}
